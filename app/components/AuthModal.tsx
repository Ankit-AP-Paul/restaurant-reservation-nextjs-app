        ...
        <Box sx={style}>
          <div className="p-2">
            ...
            <div className="m-auto">
              <h2 className="text-2xl font-light text-center mb-5">
              ...
              <AuthModelInputs
                ...
                isSignIn={isSignIn}
              />
              <button className="uppercase bg-red-600 w-full text-white p-3 rounded text-sm mt-5 disabled:bg-gray-400">
